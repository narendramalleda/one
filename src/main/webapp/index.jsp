...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .btn-secondary:hover { background: var(--primary-light, #2d2d44); border-color: var(--primary-light, #2d2d44); transform: translateY(-2px); }
    ...
    .search-wrap button {
      padding: 8px 0 8px 10px; color: var(--muted); font-size: 15px;
      transition: var(--transition);
    }
    ...
    .mobile-toggle {
      ...
      border-radius: 50%; font-size: 20px; background: var(--surface);
    ...
    .hero h1 {
      ...
      color: #fff; line-height: 1.15; max-width: 640px; margin-bottom: 16px;
    }
    .hero p {
    ...
    .timer-box .label {
      font-size: 11px; opacity: 0.70; text-transform: uppercase;
    ...
    .testimonial-card {
      flex: 0 0 340px; background: var(--card);
    ...
    /* newsletter */
    .newsletter-wrap {
      background: linear-gradient(135deg, var(--primary) 0%, var(--primary-light, #2d2d44) 100%);
